...
// Ícone do Pipeline: barrinhas coloridas (kanban)
const PipelineIcon = ({ className }: { className?: string }) => (
  <svg viewBox="0 0 24 24" className={className} aria-hidden="true">
    <rect x="3" y="5" width="4.5" height="14" rx="1.5" fill="#3B82F6" />
    <rect x="9.75" y="5" width="4.5" height="10" rx="1.5" fill="#F59E0B" />
    <rect x="16.5" y="5" width="4.5" height="6" rx="1.5" fill="#EC4899" />
  </svg>
);
